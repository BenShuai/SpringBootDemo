...
public class QuartzManager {
    ...
    public static void addJob(String jobName, String jobClass, String time) {
        try {
            ...
            JobDetail jobDetail = newJob((Class)Class.forName(jobClass)).withIdentity(jobName,JOB_GROUP_NAME).build();// new JobDetail(jobName, JOB_GROUP_NAME, Class.forName(jobClass));// 任务名，任务组，任务执行类
            // 触发器
