package com.zuul.geteway.filter;
 ...
 * 为了方便拦截此场景的uri，我们自己约定一个规范，及uri中含有user/internal<br>
 * 如在oauth登陆的时候用到根据username查询用户，<br>
 * 用户系统提供的查询接口/user/internal肯定不能做登录拦截，而该接口也不能对外网暴露<br>
...
public class InternalURIAccessFilter extends ZuulFilter {
	...
	public boolean shouldFilter() {
		...
		return PatternMatchUtils.simpleMatch("/user/internal", request.getRequestURI());
	}
